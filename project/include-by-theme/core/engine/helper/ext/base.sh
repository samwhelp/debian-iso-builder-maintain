...
base_var_init () {
	...
	DEFAULT_REPO_PREFIX_NAME="debian-iso-builder-include-pacstall"
	...
	DEFAULT_WORK_DIR_PATH="${HOME}/iso-builder/debian/include-by-theme"
	...
	DEFAULT_ENTITY_THEME_LIST="attach-themes"
	REF_ENTITY_THEME_LIST="${REF_ENTITY_THEME_LIST:=$DEFAULT_ENTITY_THEME_LIST}"

	DEFAULT_ENTITY_DESKTOP_LIST="xfce kde-plasma budgie mate cinnamon gnome-shell"
