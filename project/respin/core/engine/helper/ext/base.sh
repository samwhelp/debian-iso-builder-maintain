...
base_var_init () {
	...
	DEFAULT_REPO_PREFIX_NAME="debian-iso-builder-respin"
	...
	DEFAULT_WORK_DIR_PATH="${HOME}/iso-builder/debian/respin"
	...
	DEFAULT_ENTITY_THEME_LIST="attach-themes style-maccity style-wincity theme-vimix theme-orchis theme-graphite theme-colloid theme-fluent theme-layan theme-qogir theme-lavanda"
	REF_ENTITY_THEME_LIST="${REF_ENTITY_THEME_LIST:=$DEFAULT_ENTITY_THEME_LIST}"

	DEFAULT_ENTITY_DESKTOP_LIST="xfce kde-plasma budgie mate cinnamon gnome-shell mate-with-compiz lxqt lxqt-with-kwin"
	REF_ENTITY_DESKTOP_LIST="${REF_ENTITY_DESKTOP_LIST:=$DEFAULT_ENTITY_DESKTOP_LIST}"
...
base_var_dump () {
	...
	util_debug_echo
	util_debug_echo "##"
	util_debug_echo "## ## Entity Args"
	util_debug_echo "##"
	util_debug_echo

	util_debug_echo "DEFAULT_ENTITY_THEME_LIST=${DEFAULT_ENTITY_THEME_LIST}"
	util_debug_echo "REF_ENTITY_THEME_LIST=${REF_ENTITY_THEME_LIST}"
	util_debug_echo

	util_debug_echo "DEFAULT_ENTITY_DESKTOP_LIST=${DEFAULT_ENTITY_DESKTOP_LIST}"
